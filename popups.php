  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form role="form" id="pdfModalForm">
        <!-- <form role="form" id="newModalForm" method="post" class="form-horizontal needs-validation"   novalidate> -->
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input required type="text" class="form-control" name="phone" id="phone" aria-describedby="phoneHelpId" placeholder="mobile number"/>            
